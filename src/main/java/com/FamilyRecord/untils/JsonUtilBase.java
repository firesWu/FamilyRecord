...
public class JsonUtilBase {
    ...
    public static <T> String getRetJsonStr(T data) {
        ...
        try {
            ...
            logger.error("genUpdateDataReturnJsonStr 2 json ×ª»»Ê§°Ü¡£\n", var3);
        }
    ...
    public static <T> String genUpdateDataReturnJsonStr(boolean success, String mgs, T data, String code) {
        ...
        try {
            ...
            logger.error("retMap£º" + data + "----success:" + success + "------mgs:" + mgs + "------code:" + code);
            logger.error("genUpdateDataReturnJsonStr 2 json ×ª»»Ê§°Ü¡£\n", var7);
        }
    ...
    public static <T> String genUpdateDataReturnJsonStr(T data) {
        ...
        try {
            ...
            logger.error("retMap£º" + data);
            logger.error("genUpdateDataReturnJsonStr 3 json ×ª»»Ê§°Ü¡£\n", var3);
        }
    ...
    public static <T> void genUpdateDataReturnJsonStr(T data, OutputStream os) {
        try {
            ...
            logger.error("retMap£º" + data);
            logger.error("genUpdateDataReturnJsonStr 5 json ×ª»»Ê§°Ü¡£\n", var6);
        }
